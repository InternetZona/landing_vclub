    ...
    <div class="container">
        ...
        <div class="row" style="margin-top: 30px;">
            ...
            <div class="col s12 m12  push-l2 l8">
                <div class="text-box">
                    <p>Если Вы планируете посещать клуб вместе с семьёй, другом, подругой, то мы предлагаем Вам забронировать 2 карты «Без ограничений» 
                    с еще большей скидкой!</p>
                    <p>Скидка 13 000 рублей! Экономия 26 000 рублей при заказе 2 карт.</p>
                    <p>Закажите 2 карты сейчас и приходите в Vavilov Club на презинтацию.</p>
                </div>  
            </div>
